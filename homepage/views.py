    ...
    if request.method == "GET":
        ...
        if user_form.is_valid():
            ...
            if result['success']:
                ...
                return HttpResponse(json.dumps({"message":"Registration Successful. Kindly expect an email from us. Kindly check your spam if you don't receive an email. See you at Kalanjali 2019.",}),content_type="application/json")
            else:
